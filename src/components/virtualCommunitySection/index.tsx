    ...
    <div className="container text-center">
      <div className="row justify-content-center">
        <div className="col-12 col-lg-10">
          ...
          <p className="mb-0">Be a member of QC's supportive Virtual Community where students and graduates can connect with mentors, share insights and grow together. Tap into free webinars where top design professionals share industry secrets, and take part in lively discussions covering everything from your latest assignment to your next career move. We're here to inspire and enhance your educational journey.</p>
          <p className="text-black">Join us in shaping the future of the design industry.</p>
        </div>
      </div>
