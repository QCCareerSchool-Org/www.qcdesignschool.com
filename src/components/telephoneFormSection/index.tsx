              ...
              <FormWrapper>
                {state === 'ready' && (
                  <form onSubmit={handleSubmit}>
                    ...
                    <p><small>By providing your phone number, you agree to receive automated promotional messages from QC Design School. Message frequency varies. Message & data rates may apply. Reply STOP to opt out. <Link href="/terms" target="_blank">Terms & Privacy</Link>.</small></p>
