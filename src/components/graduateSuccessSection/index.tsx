      ...
      <div className="container">
        <div className="row justify-content-center text-center mb-5">
          <div className="col-12 col-lg-10 col-xl-8">
            ...
            <p className="text-muted mb-0">Whether you're pivoting careers, expanding services, or launching a business, our graduates prove that QC's IDDP™ credential and business tools are the fastest path to a thriving interior {designRestricted ? 'decorating' : 'design'} career.</p>
          </div>
        </div>
