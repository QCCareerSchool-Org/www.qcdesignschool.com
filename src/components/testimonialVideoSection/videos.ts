...
export const videos: TestimonialVideo[] = [
  {
    src: 'https://cdn.qccareerschool.com/design/design-reviews-alexa.mp4',
  ...
  {
    src: 'https://cdn.qccareerschool.com/design/design-reviews-daniella.mp4',
  ...
  {
    src: 'https://cdn.qccareerschool.com/design/design-reviews-trish.mp4',
