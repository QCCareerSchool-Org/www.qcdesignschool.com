  ...
  <div className={styles.page}>
        ...
        <div className="row justify-content-center g-s">
          <div className="col-12">
            <Hero src={HeroImage} priority objectPosition="100% 0">
              ...
              <p className="h5 mb-3 mb-xl-5">Master the Art of Feng Shui</p>
      ...
      <div className="container">
        <div className="row justify-content-center g-s">
          <div className="col-12 col-lg-6">
            ...
            <p className="lead mb-4">QC&rsquo;s online Feng Shui Design certification course gives you the skills to create harmony and balance in your own home—or to launch a rewarding career helping others transform their spaces. QC&rsquo;s expert-led curriculum prepares you for any project by delving into the core principles of feng shui design including energy flow, color harmony and spatial arrangement.</p>
            <ul>
              <li>Get started now—QC&rsquo;s premium Feng Shui Design course will take you from beginner to expert with no previous training required</li>
    ...
    <section>
      <div className="container">
        ...
        <div className="text-center mt-4">
          <Link href="https://enroll.qcdesignschool.com/?c=fs"><button className="btn btn-primary btn-lg mb-5">Unlock a Free Bagua Map Preview</button></Link>
        </div>
      </div>
    </section>
