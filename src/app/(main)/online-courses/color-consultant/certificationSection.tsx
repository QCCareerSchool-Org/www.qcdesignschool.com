...
export const CertificationSection: FC = () => (
  <CertificationSectionTemplate backgroundImageSrc={CertificationBackgroundImage}>
    <CertificationLogo height="200" className="mb-3" title="International Color Consulting Professional (ICCP) certification logo" />
    <p className="mb-3 small lightGold">International Color Consulting Professional&trade; (ICCP&trade;)</p>
