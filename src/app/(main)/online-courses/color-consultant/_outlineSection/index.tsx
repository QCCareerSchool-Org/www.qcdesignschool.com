    ...
    <div className="container">
      <div className="row justify-content-center g-s">
        <div className="col-12 col-xl-10 text-center">
          ...
          <p className="lead mb-0">Accelerate Your Business training is divided into five parts, each comprising separate training units.</p>
        </div>
        <div className="col-12 col-xl-10">
          ...
          <CourseOutline title="Build an Online Presence" src={Part2Image} className="mb-3">
            <p className="small">Now that you have a better understanding of branding, you’ll start to put that knowledge to good use as you explore your online presence, from your website to your social media presence. You’ll learn about what makes a “good” website, how to effectively manage your social media presence, how to handle negative reviews, marketing your business online, the art of blogging, content marketing and more.</p>
          </CourseOutline>
          ...
          <CourseOutline title="Successful Project Management" src={Part4Image} className="mb-3">
