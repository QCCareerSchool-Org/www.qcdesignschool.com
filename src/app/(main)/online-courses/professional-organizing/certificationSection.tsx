    ...
    <div className="container">
      <div className="row justify-content-center align-items-center g-5">
        ...
        <div className="col-12 col-lg-7 text-start">
          ...
          <p>This certification demonstrates that you have successfully completed professional organizing training and that you possess all the skills and knowledge required to create functional and comfortable homes.</p>
