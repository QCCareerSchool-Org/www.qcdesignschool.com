        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10">
              ...
              <AccordionFAQ heading="How much does a landscape designer make?" className="mb-3">
              ...
              <AccordionFAQ heading="Do I need a degree to work as a landscape designer?" className="mb-3">
              ...
              <AccordionFAQ heading="How long does it take to become a certified landscape designer?" className="mb-3">
              ...
              <AccordionFAQ heading="Can I start a landscape design business after completing the course?" className="mb-3">
