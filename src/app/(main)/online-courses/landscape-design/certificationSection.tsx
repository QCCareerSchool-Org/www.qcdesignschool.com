...
export const CertificationSection: FC = () => (
  <CertificationSectionTemplate backgroundImageSrc={CertificationBackgroundImage}>
    <CertificationLogo height="200" className="mb-3" title="International Landscape Design Professional (ILDP) certification logo" />
    <p className="mb-3 small lightGold">International Landscape Design Professional&trade; (ILDP&trade;)</p>
