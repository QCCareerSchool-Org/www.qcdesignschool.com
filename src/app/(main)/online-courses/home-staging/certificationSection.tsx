...
export const CertificationSection: FC = () => (
  <CertificationSectionTemplate backgroundImageSrc={CertificationBackgroundImage}>
    <CertificationLogo height="200" className="mb-3" title="International Staging and Redesign Professional (ISRP) certification logo" />
    <p className="mb-3 small lightGold">International Staging and Redesign Professional&trade; (ISRP&trade;)</p>
