...
import Part3Image from './Build an Online Presence.jpg';
import Part1Image from './Establish Your Brand and Business Goals.jpg';
import Part2Image from './Showcase Your Business to Prospective Clients.jpg';
    ...
    <div className="container">
      <div className="row justify-content-center g-s">
        <div className="col-12 col-xl-10 text-center">
          ...
          <p className="lead mb-0">QC's Accelerate Your Business workshop is divided into four comprehensive training units designed to refine your skills and jumpstart your career.</p>
        </div>
        <div className="col-12 col-xl-10">
          ...
          <CourseOutline title="Showcase Your Business to Prospective Clients" src={Part3Image} className="mb-3">
            <p className="small">Discover how to present your business to attract prospective clients. You'll learn to develop an eye-catching professional portfolio to showcase your skills, and practice effective communication strategies for working with clients. You'll study the process of creating high-quality client proposals to sell your services.</p>
          </CourseOutline>
