      ...
      <section>
        <div className="container">
          ...
          <QuestionAndAnswer heading="Interior decorator vs. an interior designer: what's the difference?">
            ...
            <p>Whether you aspire to become an interior decorator or designer, QC Design School's online Interior Design course equips you with the skills and knowledge to build a successful, rewarding career. You'll master the elements and principles of design, color theory, textiles, furniture selection, and space planning to create stunning, functional interiors your clients will love.</p>
          </QuestionAndAnswer>
          <QuestionAndAnswer heading={`How much does an interior ${designRestricted ? 'decorator' : 'designer'} earn?`}>
            ...
            <p>* Occupational Outlook Handbook. U.S. Bureau of Labor Statistics. April 2025. <Link href="https://www.bls.gov/ooh/arts-and-design/interior-designers.htm" target="_blank" rel="noreferrer">https://www.bls.gov/ooh/arts-and-design/interior-designers.htm</Link></p>
          </QuestionAndAnswer>
