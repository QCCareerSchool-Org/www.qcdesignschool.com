...
export const CertificationSection: FC = () => {
  ...
  return (
    <CertificationSectionTemplate backgroundImageSrc={CertificationBackgroundImage} overlayColor="rgb(0,0,0,0.2)">
      ...
      <p className="mb-0">This certification demonstrates that you have successfully completed professional interior {designRestricted ? 'decorator' : 'design'} training and that you possess all the skills and knowledge required to create beautiful and comfortable homes.</p>
