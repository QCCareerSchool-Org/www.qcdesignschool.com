    ...
    <div className="container">
      <div className="row justify-content-center g-s">
        <div className="col-12 col-xl-10 text-center">
          ...
          <p className="lead mb-0">QC's Interior {designRestricted ? 'Decorating' : 'Design'} course is divided into 6 comprehensive training units crafted to build your design skills step-by-step.</p>
        </div>
