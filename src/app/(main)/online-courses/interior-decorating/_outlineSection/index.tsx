    ...
    <div className="container">
      <div className="row justify-content-center g-s">
        <div className="col-12 col-xl-10 text-center">
          ...
          <p className="lead mb-0">QC's Interior Decorating course is divided into 6 comprehensive training units crafted to build your design skills step-by-step.</p>
        </div>
        <div className="col-12 col-xl-10">
          <CourseOutline title="The Fundamentals of Design" src={Part1Image} open className="mb-3">
            <p className="small">Learn about the elements and principles of design, and study your role as a professional interior decorator. You'll begin your certification course with an in-depth look at the entire decorating process, from signing the contract to implementing the design. You'll study color theory and become familiar with various popular design styles, from country to contemporary.</p>
          </CourseOutline>
          ...
          <CourseOutline title="Floorplans and Layouts" src={Part4Image} className="mb-3">
            <p className="small">Become a master of one of the building blocks of interior decorating: drawing professional floorplans. First, you'll learn how to measure and sketch the dimensions of a room. Use these skills to draw scaled floorplans for clients to present a bird's-eye view of your home design plans. Discover how to use balance, visual weight and traffic patterns to place furniture within different spaces. Throughout this unit, you'll be guided by step-by-step videos featuring QC instructor Angie Chapman.</p>
          </CourseOutline>
          <CourseOutline title="Your Final Project" src={Part5Image} className="mb-3">
            <p className="small">For your final project, you'll draw on everything you've learned in your interior decorating course. You'll create a custom-designed space for a mock client, and show off all the skills you've gained as a home design student. With personalized feedback, you'll be ready to launch your interior decorating career!</p>
          </CourseOutline>
          <CourseOutline title="The Business of Design" src={Part6Image}>
            <p className="small">You'll have the option to complete a specialized business unit designed for interior decorators. Learn how to start and register your own business. Explore the world of marketing and promotion, including in-depth guidance to help you build your brand and market your business online. Selling your services, creating contracts and maintaining good client relationships are all covered as you learn about working with clients. You'll also study special topics such as working with contractors and using interior decorating software, and gain access to essential business templates to help you work with clients efficiently. In a bonus online text, discover how to create a stunning interior decorating portfolio that will help to attract new clients and build your brand.</p>
          </CourseOutline>
        </div>
