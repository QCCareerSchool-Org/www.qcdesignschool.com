...
import Part5Image from './Designing Room by Room.jpg';
...
import Part7Image from './The Business of Design.jpg';
    ...
    <div className="container">
      <div className="row justify-content-center g-s">
        ...
        <div className="col-12 col-xl-10">
          ...
          <CourseOutline title="Designing Room by Room" src={Part5Image} className="mb-3">
          ...
          <CourseOutline title="Your Final Project" src={Part6Image} className="mb-3">
          ...
          <CourseOutline title="The Business of Design" src={Part7Image}>
