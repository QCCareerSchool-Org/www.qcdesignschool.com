    ...
    <div className="container">
      ...
      <div className="row justify-content-center g-5">
        <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-3">
          ...
          <p className={styles.heading}><strong>Quality:</strong> You'll see QC's commitment to quality reflected in every aspect of your design courses.</p>
        ...
        <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-3">
          ...
          <p className={styles.heading}><strong>Innovation:</strong> QC Design School is continuously working to improve your online learning experience.</p>
          <ul className={`${styles.list} mb-0 small`}>
