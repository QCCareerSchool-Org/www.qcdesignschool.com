...
import FeedbackIcon from '@/components/icons/check-speech.svg';
      ...
      <div className="container">
        <div className="row justify-content-center g-s align-items-center">
          <div className="col-12 col-lg-7">
            <h1 className="h2 mb-4">How QC's Online Design Courses Work</h1>
            <p className="mb-0">QC Design School offers flexible, self-paced online courses you can complete from home. You'll get hands-on training, detailed feedback, and personal guidance throughout the course.</p>
            <ul className="mb-0">
              <li className="col-12">Each online design course includes digital lessons, video tutorials, and customizable business templates.</li>
              <li className="col-12">You'll complete theory-based and practical assignments to hone your design skills, and submit them for tutor feedback and grading.</li>
