        ...
        <div className="container">
          <div className="row text-white">
            <div className="col-12 col-lg-9 col-xl-8">
              <MapleLeafIcon height={60} />
              <h1 className="text-shadow mb-4">Canadian Student Tax Credits</h1>
              <h6 className="mb-4">Can You Save Money on QC Design School Tuition?</h6>
              <p className="mb-0">If you're a Canadian resident studying with QC Design School, you may be able to reduce the cost of your tuition through federal student tax credits. Because QC Design School is recognized by Employment and Social Development Canada (ESDC) for tax purposes, eligible tuition may qualify for Canadian tuition tax credits.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-lg">
              <h4 className="mb-3">What Tax Credits Can Canadian Students Claim?</h4>
            ...
            <div className="col-12 col-lg">
              <div className={styles.wrapper}>
                <div className="d-flex gap-3">
                  <div>
                    <BiBulb size={24} className={styles.icon} />
                  </div>
                  <div>
          ...
          <div className="row justify-content-center mt-5">
            <div className={`${styles.CTCbox} col-12 col-lg-5 mb-3 mb-lg-0 me-4 d-flex`}>
              <div className="d-flex flex-column justify-content-between">
                <div>
                  <h4 className="mb-0">1. Canada Training Credit (CTC)</h4>
                  ...
                  <div className={`${styles.howItWorks} mb-3`}>
                    <h6>How it Works</h6>
                    ...
                    <p><BiCheckCircle size={20} className="text-success" style={{ position: 'relative', top: -1 }} /> Up to 50% of eligible tuition fees, or </p>
                    <p><BiCheckCircle size={20} className="text-success" style={{ position: 'relative', top: -1 }} /> Your available CTCL balance (whichever is lower)</p>
                  </div>
                </div>
            ...
            <div className={`${styles.CTCbox} col-12 col-lg-5 mb-3 mb-lg-0 d-flex`}>
              <div className="d-flex flex-column justify-content-between">
                <div>
          ...
          <div className={styles.caseBody}>
            <div className="row">
              <div className="col-12 col-lg-8">
                <h6>Step 1: Canada Training Credit</h6>
                ...
                <h6 className="mb-3">Estimated Total Savings</h6>
                <div className={styles.howItWorks}>
                  ...
                  <div className="d-flex justify-content-between">
                    <h5 className="fw-bold mb-0">Estimated Net Cost:</h5>
                    <h5 className={`${styles.customBlue} mb-0`}>$849.15</h5>
                  </div>
                </div>
              </div>
      ...
      <section className="bg-light">
        <div className="container">
          ...
          <AccordionFAQ heading="How do I get my T2202 tax receipt from QC Design School?" className="mb-3">
            <p>QC Design School provides eligible students with a T2202 Tuition and Enrolment Certificate for tax purposes, so you're learning strategies that actually work in the real world.</p>
          ...
          <div className={styles.disclaimerBox}>
            ...
            <p><BiError size={20} className={styles.customAmber} style={{ position: 'relative', top: -1 }} /> Tax rules and eligibility requirements can change and may vary based on your income, province, and tax history.</p>
