...
const schooolName: School = 'QC Design School';
...
export const generateMetadata: GenerateMetadata<RouteParams> = async ({ params }): Promise<Metadata> => {
  ...
  const imageSrc = 'https://www.qcdesignschool.com/images/award-of-excellence.png';
  ...
  return {
    ...
    openGraph: {
      url: `https://www.qcdesignschool.com/awards/${award.submissionId}`,
      type: 'website',
      title,
      description,
...
const AwardPage: PageComponent<RouteParams> = async ({ params }) => {
  ...
  const url = `https://www.qcdesignschool.com/awards/${award.submissionId}`;
  const suggestedText = `I just earned this Award of Excellence from ${award.schoolName} for my work in ${award.courseName}! I'm so excited to be pursuing my dream career. 💫 #AwardOfExcellence @QCDesignSchool`;
        ...
        <div className="container text-center">
          <div className="row justify-content-center">
            <div className="col-12 col-sm-10 col-md-8 col-lg-6">
              ...
              <p className="lead mb-5">Celebrate your achievement by sharing your Award of Excellence with your friends and followers on social media. Don't forget to tag <b>@QCDesignSchool</b> so we can cheer you on!</p>
              <div className="mb-4">
