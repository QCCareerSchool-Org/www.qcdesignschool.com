            ...
            <div className="col-12 col-lg-10 col-xl-8">
              ...
              <div className={styles.faqGroup} id="whileYouLearn">
                ...
                <QuestionAndAnswer heading="How long will it take to complete my online design class?">
                  <p>With QC Design School's online courses, you work entirely at your own pace and decide how much time per week you want to spend developing your skills. Typically, students who work on their assignments for a short period each week will complete their design course within four to six months. You have a full year to complete your design course, so you can schedule your online design training around your lifestyle!</p>
                </QuestionAndAnswer>
