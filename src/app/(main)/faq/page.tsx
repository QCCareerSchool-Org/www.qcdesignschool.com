          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10 col-xl-8">
              ...
              <div className={styles.faqGroup} id="beforeEnroll">
                ...
                <QuestionAndAnswer header="Is QC an accredited online design school?">
                ...
                <QuestionAndAnswer header="Do I need prior training or experience before taking QC's online courses?">
                ...
                <QuestionAndAnswer header="What if I decide QC's design course is not for me?">
                ...
                <QuestionAndAnswer header="Are flexible payment plans available with each course?">
                ...
                {countryCode === 'CA' && (
                  <QuestionAndAnswer header="Can I claim my course tuition on my taxes?">
                    <p>Yes, and you could qualify to have <Link href="/canadian-tax-credits">over 50% of your course fees covered</Link>! QC is a Certified Education Institution with Employment and Social Development Canada.</p>
                  </QuestionAndAnswer>
                )}
              </div>
              ...
              <div className={styles.faqGroup} id="whileYouLearn">
                ...
                <QuestionAndAnswer header="Is it possible to learn about home design online?">
                ...
                <QuestionAndAnswer header="How long will it take to complete my online design class?">
                ...
                <QuestionAndAnswer header="What do I do if I get stuck on a design assignment?">
                ...
                <QuestionAndAnswer header="Are there any technology requirements to complete my design training online?">
                ...
                <QuestionAndAnswer header="Are there any items required to complete my design training online?">
              ...
              <div className={styles.faqGroup} id="afterYouGraduate">
                ...
                <QuestionAndAnswer header="Will I be eligible to join a professional association and/or organization upon graduation from QC Design School?">
                ...
                <QuestionAndAnswer header="Do I have to pay an annual fee to QC or join an organization in order to keep my online design certification?">
                ...
                <QuestionAndAnswer header="How will QC help me start my design career once I've finished the courses?">
                ...
                <QuestionAndAnswer header="If I take a QC design course, will I be able to start my own business?">
              ...
              <div className={styles.faqGroup} id="aboutQC">
                ...
                <QuestionAndAnswer header="Will QC's online design courses give you the training and certification you need to become a design professional?">
                ...
                <QuestionAndAnswer header="Does the tuition cover all costs of QC's design courses?">
                ...
                <QuestionAndAnswer header="Do I need a certification or license to work as an interior decorator?">
                ...
                <QuestionAndAnswer header="What's the difference between interior decorating and interior design?">
