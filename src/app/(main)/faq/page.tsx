          ...
          <div className="col-12 col-lg-10 col-xl-8">
            ...
            <div className={styles.faqGroup} id="beforeEnroll">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Is QC an accredited online design school?</h3>
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Do I need prior training or experience before taking QC's online courses?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">What if I decide QC's design course is not for me?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Are flexible payment plans available with each course?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Can I claim my course tuition on my taxes?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
            ...
            <div className={styles.faqGroup} id="whileYouLearn">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <h3 className="h5" itemProp="name">Is it possible to learn about home design online?</h3>
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">How long will it take to complete my online design class?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">What do I do if I get stuck on a design assignment?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Are there any technology requirements to complete my design training online?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Are there any items required to complete my design training online?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
            ...
            <div className={styles.faqGroup} id="afterYouGraduate">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Will I be eligible to join a professional association and/or organization upon graduation from QC Design School?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Do I have to pay an annual fee to QC or join an organization in order to keep my online design certification?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">How will QC help me start my design career once I've finished the courses?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">If I take a QC design course, will I be able to start my own business?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
            ...
            <div className={styles.faqGroup} id="aboutQC">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Will QC's online design courses give you the training and certification you need to become a design professional?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Does the tuition cover all costs of QC's design courses?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">Do I need a certification or license to work as an interior decorator?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
              ...
              <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
                <h3 className="h5" itemProp="name">What's the difference between interior decorating and interior design?</h3>
                <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                  <div itemProp="text">
