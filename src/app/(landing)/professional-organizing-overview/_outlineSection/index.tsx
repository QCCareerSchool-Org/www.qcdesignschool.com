    ...
    <div className="container">
      <div className="row justify-content-center g-s">
        <div className="col-12 col-xl-10 text-center">
          ...
          <p className="lead mb-0">QC's Professional Organizing course is comprised of five targeted training units aimed at refining your design knowledge and honing your organizing skills to a professional level.</p>
        </div>
