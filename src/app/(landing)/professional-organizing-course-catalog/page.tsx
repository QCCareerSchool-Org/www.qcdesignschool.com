...
import { SplitCertificationSection } from '../../(main)/online-courses/professional-organizing/certificationSection';
...
const FreeCatalogPage: PageComponent = ({ searchParams }) => {
  ...
  return(
    <>
      ...
      />
      <FreeCatalogComponent courseName="Professional Organizing" professionTitle="Professional Organizer" CertificationSection={SplitCertificationSection} />
    </>
  );
};
