...
export const CourseOverview: FC<Props> = ({ countryCode, provinceCode, date }) => (
  <>
    <CourseJsonLd courseCode="i2" />
    <Header countryCode={countryCode} logoLink buttonContent={<><span className="d-none d-sm-inline">Enroll Online</span></>} buttonHref="https://enroll.qcdesignschool.com/all-courses-offer" />
