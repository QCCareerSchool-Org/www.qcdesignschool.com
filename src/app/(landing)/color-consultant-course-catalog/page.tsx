...
const ColorConsultantCourseCatalogPage: PageComponent = async props => {
  ...
  return (
    <>
          ...
          <div className="row g-0">
            <div className="col-12 col-md-7 col-lg-6 col-xl-5">
              <FormCard>
                ...
                <FormWrapper>
                  <BrevoForm
                    successLocation={`${process.env.NEXT_PUBLIC_HOST ?? 'https://www.qcdesignschool.com'}/thank-you-color-consultant-course-catalog`}
                    listId={brevoListId}
                    telephoneListId={50}
      ...
      <HowYoullLearnSection courseCode="cc" graduateTitle="International Color Consulting Professional™ (AIOP™)" countryCode={countryCode} provinceCode={provinceCode} />
