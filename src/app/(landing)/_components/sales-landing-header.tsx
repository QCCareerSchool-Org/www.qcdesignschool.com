...
export const Header: FC<Props> = async ({ logoLink, buttonContent, showBanner, buttonHref }) => {
      ...
      <header className={styles.header}>
        ...
        <div className="container">
          <div className={styles.content}>
            ...
            {buttonContent && (
              // <ButtonWrapper>
              <Link href={buttonHref}><button className="btn btn-primary btn-md">Enroll Now</button></Link>
              // </ButtonWrapper>
            )}
          </div>
        </div>
