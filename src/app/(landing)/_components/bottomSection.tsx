...
export const BottomSection: FC<PropsWithChildren<Props>> = ({ heading = 'Get Started with a Free Course Catalog', buttonHref, buttonContent = 'Get Your Free Catalog', buttonClass = 'btn-primary', children }) => (
