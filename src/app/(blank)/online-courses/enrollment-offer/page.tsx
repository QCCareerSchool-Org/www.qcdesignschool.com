...
const InteriorDecoratingPage: PageComponent = async () => {
  ...
  return (
    <div className={`${styles.page} chos`}>
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-9 col-xl-7 text-center">
              ...
              <div className="d-flex flex-column flex-sm-row justify-content-center gap-3">
                <Link href="https://enroll.qcdesignschool.com/bogo-1" className="btn btn-lg btn-light">Enroll Now<BiRightArrowAlt size={24} style={{ position: 'relative', top: -1, marginLeft: '0.125rem' }} /></Link>
      ...
      <section className="bg-light" id="expertmentorship">
        <div className="container">
          <div className="row justify-content-center mb-5">
          ...
          <div className="row justify-content-center g-4">
            <div className="col-12 col-lg-6 d-flex">
              <Card>
                <div className="d-flex flex-column flex-md-row align-items-center text-center text-md-start gap-3 mb-4">
      ...
      <section className="bg-dark inverted" style={{ background: 'radial-gradient(circle at 50% 50%, #051249 0%, rgba(5, 18, 73, 0) 42%), #020025' }}>
        <div className="container text-center">
          ...
          <div className="mb-3"><Link href="https://enroll.qcdesignschool.com/bogo-1"><button className="btn btn-light btn-lg">Get Started Today<BiRightArrowAlt style={{ position: 'relative', top: -1, marginLeft: '0.125rem' }} /></button></Link></div>
