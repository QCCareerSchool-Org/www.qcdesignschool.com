...
export const PlatformFeatures: FC = () => (
  <div className="row">
    <div className="col-12 col-lg-4">
      <h3 className="h5 mb-3">Lessons Designed for Busy Lives</h3>
