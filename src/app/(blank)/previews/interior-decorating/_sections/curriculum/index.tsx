      ...
      <div className="container text-center">
        ...
        <Accordion defaultActiveKey="0" className="text-start">
          <Accordion.Item eventKey="0">
            <Accordion.Header>Part 1: Discover the World of Interior Design</Accordion.Header>
            <Accordion.Body>
              <p className="lead">4 lessons | 6 assignments</p>
              <p>Step into the world of interior design and discover what a professional designer really does—from meeting with clients to creating complete, polished design plans. You'll explore the many exciting career paths available to you and start imagining your own future in this dynamic, growing industry.</p>
          ...
          <Accordion.Item eventKey="1">
            <Accordion.Header>Part 2: Work with Materials, Textiles, and Timeless Styles</Accordion.Header>
            <Accordion.Body>
              <p className="lead">7 lessons | 4 assignments</p>
              <p>Discover how the right materials can elevate a space from simple to truly stunning. In this unit, you'll get to know the most commonly used natural and synthetic materials in interior design—like wood, stone, glass, metal, and more—and learn how to pair them with textiles and wall treatments to create rich, personalized interiors. You'll dive into classic, early American, and global design styles, and explore how these timeless influences can be reimagined for today's clients.</p>
          ...
          <Accordion.Item eventKey="2">
            <Accordion.Header>Part 3: Master Modern Design Styles and the Art of Decor</Accordion.Header>
            <Accordion.Body>
              <p className="lead">5 lessons | 4 assignments</p>
          ...
          <Accordion.Item eventKey="4">
            <Accordion.Header>Part 5: Design Solutions for Everyday Spaces</Accordion.Header>
            <Accordion.Body>
              <p className="lead">4 lessons | 4 assignments</p>
          ...
          <Accordion.Item eventKey="5">
            <Accordion.Header>Part 6: Showcase Your Skills in a Client-Ready Project</Accordion.Header>
            <Accordion.Body>
              <p className="lead">8-Part Final Project</p>
          ...
          <Accordion.Item eventKey="6">
            <Accordion.Header>Part 7: Launch Your Design Career with Confidence</Accordion.Header>
            <Accordion.Body>
              <p className="lead">5 lessons | 5 assignments</p>
