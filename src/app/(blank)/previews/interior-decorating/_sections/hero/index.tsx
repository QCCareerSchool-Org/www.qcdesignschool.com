    ...
    <div className="container text-center text-white">
      <div className="row justify-content-center">
        <div className="col-12 col-md-11 col-lg-10 col-xl-9">
          ...
          <p className="lead mb-4 mb-md-0">Step inside QC's immersive Interior {designRestricted ? 'Decorating' : 'Design'} program—designed to help you build essential skills from day one. Learn how to bring your clients' vision to life and create stunning, functional spaces through expert-guided online training.</p>
