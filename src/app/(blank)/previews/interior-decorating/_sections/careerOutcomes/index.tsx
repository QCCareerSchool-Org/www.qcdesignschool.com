...
export const CareerOutcomes: FC<Props> = ({ designRestricted }) => (
  <section id="career-outcomes" className="bg-light">
    <div className="container text-center">
      ...
      <p className="mb-5">With the global home decor market surging to <strong>$751 billion</strong> in 2024 and set to exceed $1 trillion by 2032, demand for skilled interior {designRestricted ? 'decorators' : 'designers'} has never been higher. Now is the perfect time to transform your creativity into a successful and fulfilling design career!</p>
