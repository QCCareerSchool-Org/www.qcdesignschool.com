...
export const POST = async (request: NextRequest): Promise<Response> => {
  ...
  try {
    ...
    const createContactResult = await createBrevoContact(body.emailAddress, body.firstName, body.lastName, body.countryCode, body.provinceCode ?? '', { STATUS_DESIGN_LEAD: true }, body.emailOptIn ? [ body.listId ] : undefined);
